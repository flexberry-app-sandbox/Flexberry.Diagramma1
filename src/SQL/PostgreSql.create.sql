...
CREATE TABLE ApplicationLog (
 ...
 ALTER TABLE Таблица ADD CONSTRAINT FKe5425a9bed1ea036d0e5976f46ff77404e45710f FOREIGN KEY (Расчет) REFERENCES Расчет; 
CREATE INDEX Indexe5425a9bed1ea036d0e5976f46ff77404e45710f on Таблица (Расчет); 
