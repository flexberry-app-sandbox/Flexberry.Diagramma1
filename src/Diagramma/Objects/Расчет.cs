...
namespace IIS.Diagramma
{
    ...
    public class Расчет : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Diagramma.DetailArrayOfТаблица fEmpty;
        ...
        /// Расчет.
        /// </summary>
        public virtual IIS.Diagramma.DetailArrayOfТаблица Empty
        {
            get
            {
                if ((this.fEmpty == null))
                {
                    this.fEmpty = new IIS.Diagramma.DetailArrayOfТаблица(this);
                }
                IIS.Diagramma.DetailArrayOfТаблица result = this.fEmpty;
                return result;
            }
            set
            {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетE", typeof(IIS.Diagramma.Расчет));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетL", typeof(IIS.Diagramma.Расчет));
                }
            }
        }
    }
