    ...
    public class Подразделения : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПодразделенияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПодразделенияE", typeof(IIS.Diagramma.Подразделения));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПодразделенияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПодразделенияL", typeof(IIS.Diagramma.Подразделения));
                }
            }
        }
    }
